...
public class PassengerInfoPage {
    ...
    private final By INFO_TXT = By.id(".//span[@class = 'bTxt']");
    private final By RESPONSE_BLOCK = By.xpath("response");
    ...
    public BigDecimal getPrice() {
        ...
        String price = StringUtils.substringAfterLast(fullText, "for ", " EUR");
